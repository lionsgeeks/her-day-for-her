        ...
        <div class="header">
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    ...
                    <div class="font-bold">{{ $registration->ticket_number }}</div>
                </div>
            </div>
        </div>
                ...
                <div class="md:col-span-2 space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <div class="font-medium">{{ $registration->company ?? 'N/A' }}</div>
                        </div>
                        <div>
                            <div class="text-sm text-muted">Job Title</div>
                            <div class="font-medium">{{ $registration->job_title ?? 'N/A' }}</div>
                        </div>
                    </div>
