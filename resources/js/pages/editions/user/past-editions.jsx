            ...
            <div className="space-y-12">
              ...
              <div>
                ...
                <div className="flex flex-wrap justify-center gap-6">
                  {selectedEdition?.sponsors?.map((sponsor, idx) => (
                    ...
                    <>
                    <img key={idx} src={"storage/"+image.path} alt={sponsor.name} className="h-16 object-contain" />
                    </>
                    )
                  ))}
                </div>
              ...
              <div className="mt-12 text-center">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  {selectedEdition?.gallery?.slice(0, 4).map((img, idx) => (
                    <img key={idx} src={img} alt={`Gallery ${idx}`} className="rounded-md w-full h-40 object-cover" />
                  ))}
                </div>
                <Link href="/gallery">
